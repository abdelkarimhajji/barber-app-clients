...
function PostsBarber() {
    ...
    return (
        <>
        <div className="w-[100%] flex  items-center h-auto justify-center flex-col " >
            {/* start post */}
            <div className="w-[87%]   h-auto  mb-10 bg-login rounded-xl   " >
                {/* start top of post */}
