        ...
        <div className='px-5'>
            <div className={`w-full  mb-16  md:mb-20 overflow-y-scroll flex  text-white mt-[180px] 324:mt-[160px] 480:mt-[200px] gap-x-5 ${styles.hideScrollbar}`}>
                <div className="flex-shrink-0 shadow-black2 relative">
                    ...
                    <div className='absolute flex justify-center items-center text-[12px] font-semibold top-[185px] left-[40px]  cursor-pointer rounded-xl px-[15px] py-[6px] bg-red-900 hover:bg-green-900 transition-all'>
                        <p>By now </p>
