...
function NavBar(){
    return(
        <div className="480:h-[180px] boxsh bg-customBlue shadow-lg flex flex-col w-full lg:w-1/2 2xl:w-[800px] box-border fixed">
            ...
            <div className=' p-5 box-border flex '>
                ...
                <div className='flex  480:w-1/2 w-[60%]'>
                    <img src={beard} alt="" srcset="" className="  w-[40px] h-[40px] 480:w-[55px] 480:h-[55px] rounded-full"/>
                    <div className='pt-1 pl-3'>
                        <p className='text-green-600 text-sm'>Welcome</p>
                        <p className='text-white text-[11px] font-bold 480:text-[14px]'>Hey, Abdelkarim hajji</p>
                    </div>
                </div>
            ...
            <div className='w-full  px-5 flex justify-center items-center rounded-xl '>
                <div className=' 480:w-11/12 w-full   h-[40px] 480:h-[50px]  flex rounded-xl mb-6 480:mb-none'>
                    <div className='h-full w-[91%] relative'>
                        <LuSearch className='absolute text-white top-2.5 left-3 text-[20px] 480:text-[30px]'/>
                        <input type="text" placeholder='Find Your Barber' className='h-full pl-14 pr-5 bg-searchBar text-white text-sm 480:text-md w-full border-none outline-none rounded-l-xl'/>
                    </div>
                    <div className='rounded-r-xl bg-searchBar  w-[60px] flex justify-center items-center relative'>
                        <PiLineVertical className='absolute  right-9 top-[5px] text-white 480:text-[40px] text-[30px]'/>
