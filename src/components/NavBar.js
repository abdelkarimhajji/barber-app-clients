    ...
    return(
        <div className="480:h-[180px] boxsh bg-customBlue shadow-lg flex flex-col w-full lg:w-[70%] 2xl:w-[1000px] box-border fixed">
            ...
            <div className='w-full  px-5 flex justify-center items-center rounded-xl '>
                <div className=' w-full   h-[40px] 480:h-[50px]  flex rounded-xl mb-6 480:mb-none'>
                    <div className='h-full w-full relative'>
                        <LuSearch className='absolute text-white top-2.5 left-3 text-[20px] 480:text-[30px]'/>
                        <input type="text" placeholder='Find Your Barber' className='h-full pl-14 pr-5 bg-searchBar text-white text-sm 480:text-md 2xl:text-[16px] w-full border-none outline-none rounded-l-xl'/>
                    </div>
